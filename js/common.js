	...
	window.ScrollEffects = function() {
		...
		if( $('.new-hero-title').length > 0 ){
			...
			if (!$('body').hasClass("show-loader")) {
				...
				setTimeout(function() {				
					...
					gsap.to($(".new-hero-title .hero-title-placeholder div span"), {duration: 0, yPercent:0, opacity:1, stagger:0.05, delay:0, ease:Power3.easeOut });
				}, preloaderTimeout);
		...
		if ($("#hero-interaction").length) {
			...
			$(interactionTarget).mouseenter(function(e) {   
				...
				$("#ball").append('<img class="eyes-icon" src="images/eyes.png" style="transform:scale(1);">');                
			
				let imageIndex = 0;
				const images = [
					'<img class="eyes-icon" src="images/eyes1.png" style="transform:scale(1);">',
					'<img class="eyes-icon" src="images/eyes.png" style="transform:scale(1);">' 
				];
